                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="row gx-10 mb-5">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="text" class="form-control form-control-solid" name="title" value="{{$about_us->title}}" placeholder="Enter Title" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="uploadCover">
                                                    <input type="file" class="form-control form-control-solid" name="image" id="{{$about_us->image}}" accept="image/*">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <textarea required class="ckeditor form-control" name="description">{!! $about_us->description !!}</textarea>

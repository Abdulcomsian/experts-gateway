                    ...
                    <div class="flex-lg-row-fluid mb-10 mb-lg-0">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-12">
                                <!--begin::Form-->
                                <form action="{{ route('admin.update-fixed-service',$fixed_service->id) }}" method="post" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                    <!--begin::Wrapper-->
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="row gx-10 mb-5">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="text" class="form-control form-control-solid" name="title" value="{{$fixed_service->title}}" placeholder="Enter Title" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="number" class="form-control form-control-solid" name="price" value="{{$fixed_service->price}}" placeholder="Enter Price" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="text" class="form-control form-control-solid" name="short_des" value="{{$fixed_service->short_des}}" placeholder="Enter Short Description" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="file" class="form-control form-control-solid" name="image" value="{{$fixed_service->image}}" accept="image/*"/>
                                                    <div class="profileAvatar">
                                                        <img style="width: 140px !important; height: 140px !important; border-radius: 84px;" src="{{asset('fixed_service/' .$fixed_service->image)}}" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                                <!--end::Input group-->
                                            </div>

                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="row gx-10 mb-5">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="text" class="form-control form-control-solid" name="title" value="{{$new->title}}" placeholder="Enter Title" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <div class="profileAvatar">
                                                        <img style="width: 140px !important; height: 140px !important; border-radius: 84px;" src="{{asset('news/' .$new->image)}}" alt="" class="img-fluid">
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <textarea required class="ckeditor form-control" name="description">{{$new->description}}</textarea>

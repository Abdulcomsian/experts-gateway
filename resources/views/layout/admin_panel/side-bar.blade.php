<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="/">
            <img alt="Logo" src="{{asset('assets/img/logo.png')}}" style="width:180px;" class="logo"/>
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div
                ...
                <div class="menu-item">
                 ...
                 <div class="menu-item">
                    @if(Route::is('admin.practice-area') )
                    <a class="menu-link active" href="{{ url('/admin/practice-area') }}">
                    @else
                    <a class="menu-link" href="{{ url('/admin/practice-area') }}">
                    @endif
                                        <span class="menu-icon">
                                            <!--begin::Svg Icon | path: icons/duotone/Design/Sketch.svg-->
                                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('home-number.index') }}">
                        ...
                        <span class="menu-title">Manage Counter</span>
                    </a>
                </div>
                <div class="menu-item">
                    @if(Route::is('admin.services') )
                    <a class="menu-link active" href="{{ url('/admin/services-area') }}">
                    @else
                ...
                <div class="menu-item">
                    @if(Route::is('admin.expertise') )
                    <a class="menu-link active" href="{{ url('/admin/expertise') }}">
                    @else
                    <a class="menu-link" href="{{ url('/admin/expertise') }}">
                    @endif
                                        <span class="menu-icon">
                                            <!--begin::Svg Icon | path: icons/duotone/Design/Sketch.svg-->
                                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    @if(Route::is('admin.about_us') )
                    <a class="menu-link active" href="{{ url('/admin/about_us') }}">
                    @else
                    <a class="menu-link" href="{{ url('/admin/about_us') }}">
                    @endif
                                        <span class="menu-icon">
                                            <!--begin::Svg Icon | path: icons/duotone/Design/Sketch.svg-->
                                            <span class="svg-icon svg-icon-2">

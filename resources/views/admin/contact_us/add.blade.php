                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="row gx-10 mb-5">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="text" class="form-control form-control-solid" name="address" value="{{old('address')}}" placeholder="Enter Address" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="email" class="form-control form-control-solid" value="{{old('email')}}" placeholder="Enter Email" name="email">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="number" class="form-control form-control-solid" value="{{old('phone_1')}}" placeholder="Enter Phone Number" name="phone_1">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="url" class="form-control form-control-solid" value="{{old('facebook_link')}}" placeholder="Enter Facebook Link" name="facebook_link">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="url" class="form-control form-control-solid" value="{{old('instagram_link')}}" placeholder="Enter Instagram Link" name="instagram_link">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="text" class="form-control form-control-solid" value="{{old('twitter_link')}}" placeholder="Enter Twitter Link" name="twitter_link">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="text" class="form-control form-control-solid" value="{{old('linkedin_link')}}" placeholder="Enter Linkedin Link" name="linkedin_link">

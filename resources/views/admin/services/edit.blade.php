                                ...
                                @csrf
                                    ...
                                    <div class="d-flex flex-column align-items-start flex-xxl-row">
                                        ...
                                        <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Enter invoice number">
                                            <span class="fs-2x fw-bolder text-gray-800">Edit Service</span>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Top-->
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="row gx-10 mb-5">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="text" class="form-control form-control-solid" name="title" value="{{$service->title}}" placeholder="Enter Title" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <div class="profileAvatar">
                                                        <img style="width: 140px !important; height: 140px !important; border-radius: 84px;" src="{{asset('services/' .$service->image)}}" alt="" class="img-fluid">
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <textarea required class="ckeditor form-control" name="description">{{$service->description}}</textarea>
